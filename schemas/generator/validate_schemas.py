...
class SchemaValidator:
    ...
    def _is_valid_reference(self, ref: str, schema_id: str) -> bool:
    ...
    def validate_with_jsonschema(self, schema_id: str, schema_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            resolver = jsonschema.RefResolver.from_schema(schema_data, store=self.schemas)
