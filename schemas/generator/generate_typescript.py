...
class TypeScriptGenerator:
    ...
    def generate_interface(self, name: str, schema: dict[str, Any]) -> str:
        ...
        for prop_name, prop_schema in properties.items():
            ...
            if prop_name not in required:
                prop_name_with_question = f"{prop_name}?"
            else:
                prop_name_with_question = prop_name
            ...
            lines.append(f"  {prop_name_with_question}: {prop_type};")
    ...
    def generate_all(self) -> None:
        ...
        with v1_index_path.open("w") as f:
        ...
        for subdir in ["core", "websocket", "api"]:
            ...
            if subdir_path.exists():
                subdir_index_content = ["/**", f" * {subdir.title()} schemas", " */", ""]
                ...
                with subdir_index_path.open("w") as f:
