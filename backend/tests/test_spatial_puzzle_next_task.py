...
class TestSpatialPuzzleNextTask:
    ...
    def test_spatial_puzzle_solved_returns_next_puzzle(self):
        ...
        try:
            ...
            puzzle_resp = client.post(
                "/puzzle/create",
                json={"type": "spatial", "game_session_id": session_id, "user_id": user1_id},
            )
            ...
            answer_resp = client.post(
                "/puzzle/answer",
                json={"puzzle_id": puzzle["id"], "answer": "solved", "user_id": user1_id},
            )
    ...
    def test_spatial_puzzle_failed_returns_next_puzzle(self):
        ...
        try:
            ...
            puzzle_resp = client.post(
                "/puzzle/create",
                json={"type": "spatial", "game_session_id": session_id, "user_id": user_id},
            )
            assert puzzle_resp.status_code == 200
            puzzle = puzzle_resp.json()
            ...
            answer_resp = client.post(
                "/puzzle/answer",
                json={"puzzle_id": puzzle["id"], "answer": "collision", "user_id": user_id},
            )
            assert answer_resp.status_code == 200
            result = answer_resp.json()
    ...
    def test_spatial_puzzle_next_puzzle_randomization(self):
        ...
        try:
            ...
            for i in range(5):  # Reduced to 5 for faster testing
                ...
                answer_resp = client.post(
                    "/puzzle/answer",
                    json={"puzzle_id": puzzle["id"], "answer": "solved", "user_id": user_id},
                )
                assert answer_resp.status_code == 200
                result = answer_resp.json()
