...
class GameSession(BaseModel):
    ...
    countdown_duration: Optional[int] = Field(
        default=None,
...
class GameState(BaseModel):
    ...
    countdown_remaining: Optional[int] = Field(
        default=None,
...
class GameResult(BaseModel):
    ...
    puzzles_solved_per_player: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Number of puzzles solved by each player",
    )
    points_given_per_player: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Total points given by each player to teammates",
    )
    points_received_per_player: Optional[Dict[str, Any]] = Field(
        default=None,
